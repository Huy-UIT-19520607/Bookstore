...
namespace BookStore.DAO
{
    public class Customer
    {
        ...
        public BindingList<DTO.Customer> GetListCustomer()
        {
            string query = "select * from KHACHHANG";
            DataTable results = DataProvider.Instance.ExecuteQuery(query);

            BindingList<DTO.Customer> customers = new BindingList<DTO.Customer>();
        ...
        public int AddCustomer(string name, string address, string phoneNumber, string email, int debt)
        {
